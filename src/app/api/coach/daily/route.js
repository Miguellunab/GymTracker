...
{"message": "tu consejo personalizado", "action": "Entrenar Pierna | Entrenar Pecho/Espalda | Entrenar Brazos | Descanso | Descanso Activo"}`;
    ...
    console.error('Daily coach error:', error?.message || error);
    return Response.json({
